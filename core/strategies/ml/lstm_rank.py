"""LSTM sequence ranking strategy — 2-layer LSTM on factor sequences."""

from core.strategies.registry import register_ml_strategy

register_ml_strategy(
    key="lstm_rank", label="LSTM", ml_model_type="lstm", category="ml",
    desc="LSTM序列排序, 每月重训",
    params={
        ...
        "hidden": {"type": "int", "default": 48, "min": 16, "max": 128, "desc": "隐藏层维度"},
